...
import { View, Text, Button, ScrollView, Alert, TextInput, Modal } from 'react-native';
import { styled } from 'nativewind';
import Toast from 'react-native-toast-message';
import { getAllReports, deleteReport, approveReport, denyReport } from '@/lib/api/report-api';
...
const ManageReports = ({ report, onDelete, onApprove, onDeny }) => {
      ...
      >
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
          <View style={{ width: '80%', backgroundColor: 'white', padding: 20, borderRadius: 10 }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10 }}>Enter Denial Reason</Text>
            <TextInput
              style={{
                borderColor: '#ccc',
                borderWidth: 1,
